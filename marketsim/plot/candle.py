...
# plotting of a derivative - along with the theoretical price:
def plot_candlestick_derivative(df: pd.DataFrame, output_file: str | None =None, title: str ="Candlestick chart"):
    """
    Parameters
    ----------
    df : pandas.DataFrame
